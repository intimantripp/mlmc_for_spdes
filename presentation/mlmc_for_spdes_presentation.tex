...
\begin{frame}
  ...
  \include{slides/1_goals}
\end{frame}
\include{slides/1a_mlmc}
\include{slides/1b_mlmc}
\include{slides/2_goals_specific_1}
\include{slides/3_coupling_effects}
\include{slides/4_performance}
\include{slides/5_parallelism}

\include{slides/9_dk_fe}
