...
alternative noise coupling strategies.
...
In the context of SPDEs, a third dimension can be added, as
solvers for each sample can also be parallelised. We examine several 
...
same level at once), and heterogeneous (different processor 
...
completing MLMC simulations with over $7 \times 10^{10}$ unknowns 
